...
datafile = os.path.expanduser('~/data/geo/multi-maps/idps.2015.csv')
...
title = f'Internally displaced persons, {year}'

description = '''Internally displaced persons. Source: unhcr.org, Population Statistics'''
...
ax = merged.dropna().plot(column='idps', cmap=cmap, figsize=figsize, scheme='fisher_jenks', k=colors, legend=True)
