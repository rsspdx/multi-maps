...
for i in range(len(data_dictionary)-1):
    ...
    if data_dictionary[i]['name'] == 'co2_tons_per_capita' or data_dictionary[i]['name'] == 'energy_use_per_capita':
        csv = csv.rename(index =  str, columns={'Country Name' : 'country', 'Country Code': 'country.code', '2014': data_dictionary[i]['name']})
    elif data_dictionary[i]['name'] == 'net_migration':
        csv = csv.rename(index =  str, columns={'Country Name' : 'country', 'Country Code': 'country.code', '2017': data_dictionary[i]['name']})
    else:
        csv = csv.rename(index =  str, columns={'Country Name' : 'country', 'Country Code': 'country.code', '2015': data_dictionary[i]['name']})
