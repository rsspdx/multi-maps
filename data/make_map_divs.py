...
{'varname': 'fdi_net_pct_gdp_resid', 'long_name': 'Net Foreign Direct Investment as % of GDP, Residuals from Regressio on GDP per Capita', 'short_name': 'FDI, % of GDP, Residuals', 'source': 'World Bank, World Development Indicators'},
 ]
